package br.com.felix.os.resources;
...
import br.com.felix.os.services.ClienteService;
...
public class ClienteResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ClienteDTO> update(@PathVariable("id") Integer id, @Valid @RequestBody ClienteDTO objDTO){
